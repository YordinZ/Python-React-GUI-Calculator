      ...
      <div className="bg-[#1a1b28] rounded-2xl shadow-2xl overflow-hidden border border-gray-800/50">
        <div className="flex items-center justify-between px-6 py-4 bg-[#111827] border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-semibold">form_calculadora.py</span>
          </div>
        ...
        <div className="relative">
          <pre className="overflow-x-auto overflow-y-auto max-h-96 p-6 text-sm leading-relaxed scrollbar-thin scrollbar-thumb-purple-600 scrollbar-track-gray-800">
